...
$.extend($.easing, {
  ...
  (function (t) {
    var e, i, a, n, o, s, r;
    (Vistaar.$window = t(window)),
      (Vistaar.$body = t(document.body)),
      (Vistaar.status = ""),
      (Vistaar.isIE = navigator.userAgent.indexOf("Trident") >= 0),
      (Vistaar.isEdge = navigator.userAgent.indexOf("Edge") >= 0),
      (Vistaar.isMobile =
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          navigator.userAgent
        )),
      (Vistaar.call = function (t, e) {
        setTimeout(t, e);
      }),
      (Vistaar.parseOptions = function (t) {
        return "string" == typeof t
          ? JSON.parse(t.replace(/'/g, '"').replace(";", ""))
          : {};
      }),
      (Vistaar.parseTemplate = function (t, e) {
        return t.replace(/\{\{(\w+)\}\}/g, function () {
          return e[arguments[1]];
        });
      }),
      (Vistaar.byId = function (t) {
        return document.getElementById(t);
      }),
      (Vistaar.byTag = function (t, e) {
        return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t);
      }),
      (Vistaar.byClass = function (t, e) {
        return e
          ? e.getElementsByClassName(t)
          : document.getElementsByClassName(t);
      }),
      (Vistaar.setCookie = function (t, e, i) {
        var a = new Date();
        a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3),
          (document.cookie =
            t + "=" + e + ";expires=" + a.toUTCString() + ";path=/");
      }),
      (Vistaar.getCookie = function (t) {
        for (
      ...
      (Vistaar.requestTimeout = function (t, e) {
        var i =
      ...
      (Vistaar.requestInterval = function (t, e, i) {
        var a =
          window.requestAnimationFrame ||
          window.webkitRequestAnimationFrame ||
          window.mozRequestAnimationFrame;
      ...
      (Vistaar.deleteTimeout = function (t) {
        if (t) {
          var e =
      ...
      (Vistaar.initCartAction = function (e) {
        Vistaar.$body
      ...
      (Vistaar.initScrollTopButton = function () {
        var e = Vistaar.byId("scroll-top");
      ...
      (Vistaar.stickyToolboxOptions = {
        minWidth: 0,
        maxWidth: 767,
        top: !1,
        scrollMode: !0,
      }),
      (Vistaar.stickyProductOptions = {
        minWidth: 0,
        maxWidth: 2e4,
        scrollMode: !0,
        top: !1,
      ...
      (Vistaar.windowResized = function (e) {
        return (
          e == Vistaar.resizeTimeStamp ||
            (void 0 === window.innerHeight &&
              (window.innerWidth =
                t(window).width() + Vistaar.getScrollbarWidth()),
            (Vistaar.resizeChanged = Vistaar.canvasWidth != window.innerWidth),
            (Vistaar.canvasWidth = window.innerWidth),
            (Vistaar.resizeTimeStamp = e)),
          Vistaar.resizeChanged
        );
      }),
      (Vistaar.getScrollbarWidth = function () {
        if (void 0 === Vistaar.scrollbarSize) {
          var t = document.createElement("div");
          (t.style.cssText =
            "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;"),
            document.body.appendChild(t),
            (Vistaar.scrollbarSize = t.offsetWidth - t.clientWidth),
            document.body.removeChild(t);
        }
        return Vistaar.scrollbarSize;
      }),
      (Vistaar.stickyContent = (function () {
        function e(t, e) {
          return this.init(t, e);
        }
        function i() {
          Vistaar.$window.trigger("sticky_refresh.Vistaar", {
            index: 0,
            offsetTop: 0,
          });
        }
        function a(t) {
          (t && !Vistaar.windowResized(t.timeStamp)) ||
            (Vistaar.$window.trigger("sticky_refresh_size.Vistaar"), i());
        }
        return (
          (e.prototype.init = function (e, i) {
            (this.$el = e),
              (this.options = t.extend(
                ...
                Vistaar.stickyDefaultOptions,
                i,
                Vistaar.parseOptions(e.attr("data-sticky-options"))
              )),
              Vistaar.$window
                .on("sticky_refresh.Vistaar", this.refresh.bind(this))
                .on("sticky_refresh_size.Vistaar", this.refreshSize.bind(this));
          }),
                    ...
                    (this.scrollPos <= i && a.hasClass("fix-bottom"))
                      ? (a.addClass("fixed"),
                        ...
                        a.hasClass("product-sticky-content") &&
                          Vistaar.$body.addClass("addtocart-fixed"))
                      : (a
                          .removeClass("fixed")
                          .css("margin-top", "")
                          .css("margin-bottom", ""),
                        ...
                        a.hasClass("product-sticky-content") &&
                          Vistaar.$body.removeClass("addtocart-fixed")),
                    (this.scrollPos = i))
                  : (a.addClass("fixed"), this.onFixed && this.onFixed()),
                a.is(".fixed.fix-top")
                  ? ((e.offsetTop += a[0].offsetHeight),
                    (Vistaar.sticky_top_height = e.offsetTop))
          ...
          Vistaar.$window.on("Vistaar_complete", function () {
            window.addEventListener("scroll", i, { passive: !0 }),
              Vistaar.$window.on("resize", a),
              setTimeout(function () {
                a();
              }, 300);
          }),
          function (i, a) {
            Vistaar.$(i).each(function () {
              var i = t(this);
      ...
      (Vistaar.parallax = function (e, i) {
        t.fn.themePluginParallax &&
          Vistaar.$(e).each(function () {
            var e = t(this);
            e.themePluginParallax(
              t.extend(
                !0,
                Vistaar.parseOptions(e.attr("data-parallax-options")),
                i
              )
            );
          });
      }),
      (Vistaar.skrollrParallax = function () {
        Vistaar.isMobile ||
          ("undefined" != typeof skrollr &&
            Vistaar.$(".skrollable").length &&
            skrollr.init({ forceHeight: !1 }));
      }),
      (Vistaar.initFloatingParallax = function () {
        t.fn.parallax &&
          Vistaar.$(".floating-item").each(function (e) {
            var i = t(this);
            i.data("parallax") &&
              (i.parallax("disable"),
              ...
              i.parallax(Vistaar.parseOptions(i.data("options")));
          });
      }),
      (Vistaar.isotopeOptions = {
        itemsSelector: ".grid-item",
        layoutMode: "masonry",
        percentPosition: !0,
        masonry: { columnWidth: ".grid-space" },
      }),
      (Vistaar.isotopes = function (e, i) {
          ...
          Vistaar.$(e).each(function () {
            var e = t(this),
              n = t.extend(
                ...
                {},
                a.isotopeOptions,
                Vistaar.parseOptions(e.attr("data-grid-options")),
                i || {}
              );
            Vistaar.lazyLoad(e),
      ...
      (Vistaar.initNavFilter = function (e) {
        t.fn.isotope &&
          Vistaar.$(e).on("click", function (e) {
            var i = t(this),
            ...
            t(n || ".grid")
              ...
              .isotope("on", "arrangeComplete", function () {
                Vistaar.$window.trigger("appear.check");
              }),
      ...
      (Vistaar.ratingTooltip = function (t) {
        for (
          var e = Vistaar.byClass("ratings-full", t || document.body),
            i = e.length,
            a = function () {
              var t =
      ...
      (Vistaar.setProgressBar = function (e) {
        Vistaar.$(e).each(function () {
          var e = t(this),
      ...
      (Vistaar.alert = function (e) {
        Vistaar.$body.on("click", e + " .btn-close", function (i) {
          i.preventDefault(),
            t(this)
              .closest(e)
              .fadeOut(function () {
      ...
      (Vistaar.closeTopNotice = function (e) {
        Vistaar.$body.on("click", e, function (e) {
          e.preventDefault(), t(".top-banner").slideUp();
        });
      }),
      (Vistaar.accordion = function (e) {
        Vistaar.$body.on("click", e, function (e) {
          var a = t(this),
      ...
      (Vistaar.animationOptions = {
        name: "fadeIn",
        duration: "1.2s",
        delay: ".2s",
      }),
      (Vistaar.appearAnimate = function (e) {
        Vistaar.$(e).each(function () {
          var e = this;
          Vistaar.appear(e, function () {
            if (e.classList.contains("appear-animate")) {
              var i = t.extend(
                {},
                Vistaar.animationOptions,
                Vistaar.parseOptions(e.getAttribute("data-animation-options"))
              );
              setTimeout(
                function () {
      ...
      (Vistaar.priceSlider = function (e, i) {
      ...
      (Vistaar.stickySidebar = function (e) {
        if (t.fn.themeSticky) {
          var i = 0;
          function a() {
            Vistaar.$(e).trigger("recalc.pin"),
          ...
          !t(".sticky-sidebar > .filter-actions").length &&
            ...
            setTimeout(a, 300),
            Vistaar.$window.on("click", ".tab .nav-link", function () {
              setTimeout(a);
            });
        }
      }),
      (Vistaar.zoomImageOptions = {
        responsive: !0,
        borderSize: 0,
        zoomType: "inner",
        onZoomIn: !0,
      ...
      (Vistaar.zoomImageObjects = []),
      (Vistaar.zoomImage = function (e) {
        t.fn.zoom &&
          e &&
          ("string" == typeof e ? t(e) : e).find("img").each(function () {
            var e = t(this);
            (Vistaar.zoomImageOptions.target = e.parent()),
              (Vistaar.zoomImageOptions.url = e.attr("data-zoom-image")),
              e.zoom(Vistaar.zoomImageOptions),
              Vistaar.zoomImageObjects.push(e);
          });
      }),
      (Vistaar.zoomImageOnResize = function () {
        Vistaar.zoomImageObjects.forEach(function (e) {
          e.each(function () {
      ...
      (Vistaar.lazyLoad = function (t, e) {
        ...
        Vistaar.$(t)
          .find(".lazy-img")
          .each(function () {
            void 0 !== e && e ? i.call(this) : Vistaar.appear(this, i);
          });
      }),
      (Vistaar.initPopup = function (e, i) {
        Vistaar.$body.hasClass("home") &&
          "true" !== Vistaar.getCookie("hideNewsletterPopup") &&
          setTimeout(function () {
            Vistaar.popup({
              ...
              callbacks: {
                beforeClose: function () {
                  t("#hide-newsletter-popup")[0].checked &&
                    Vistaar.setCookie("hideNewsletterPopup", !0, 7);
                },
              },
            });
          }, 7500),
          Vistaar.$body.on("click", ".btn-iframe", function (e) {
            e.preventDefault(),
              Vistaar.popup(
                {
                  items: {
      ...
      (Vistaar.initNotificationAlert = function () {
        Vistaar.$body.hasClass("has-notification") &&
          setTimeout(function () {
            Vistaar.$body.addClass("show-notification");
          }, 5e3);
      }),
      (Vistaar.countTo = function (e) {
        t.fn.countTo &&
          Vistaar.$(e).each(function () {
            Vistaar.appear(this, function () {
              var e = t(this);
              setTimeout(function () {
                e.countTo({
                  onComplete: function () {
        ...
        }),
        {
          init: function () {
            ...
            (i.className = "minipopup-area"),
              Vistaar.byClass("page-wrapper")[0].appendChild(i),
              (e = t(i)),
          ...
          open: function (n, l) {
            var c,
              d = this,
              p = t.extend(!0, {}, Vistaar.minipopupOption, n);
            (c = t(Vistaar.parseTemplate(p.template, p))), (d.space = p.space);
            ...
            u.length &&
              u.on("load", function () {
                (i += c[0].offsetHeight + d.space),
                  ...
                  Vistaar.$body.on("touchstart", function () {
                    d.resume();
                  }),
                  a.push(c),
      ...
      (Vistaar.headerToggleSearch = function (t) {
        var e = Vistaar.$(t);
        Vistaar.$body.on("click", ".hs-toggle .search-toggle", function (t) {
          t.preventDefault();
        }),
          "ontouchstart" in document
            ? (e.find(".search-toggle").on("click", function (t) {
              ...
              Vistaar.$body.on("click", function (t) {
                e.removeClass("show");
              }),
  ...
  (function (t) {
    var e = function (t) {
        t.preventDefault(), Vistaar.$body.addClass("mmenu-active");
      },
      i = function (t) {
        t.preventDefault(), Vistaar.$body.removeClass("mmenu-active");
      },
      a = {
        init: function () {
          this.initMenu(),
        ...
        initMenu: function () {
          t(".menu li").each(function () {
            ...
            Vistaar.$window.on("resize", function () {
  ...
  (function (t) {
      ...
      a = function (t) {
        ...
        for (e = 0; e < a; ++e)
          if (!i[e].classList.contains("active")) {
            var n,
              o = Vistaar.byClass("appear-animate", i[e]);
          ...
          .each(function () {
            var i = t(this),
              a = t.extend(
                ...
                {},
                Vistaar.animationOptions,
                Vistaar.parseOptions(i.data("animation-options"))
              ),
              n = a.duration,
              o = a.delay,
              s = a.name;
          ...
          a.find(".swiper-slide .slide-animate").each(function () {
            var e = t(this),
              i = t.extend(
                ...
                {},
                Vistaar.animationOptions,
                Vistaar.parseOptions(e.data("animation-options"))
              );
          ...
          if (
            ...
            if (
              ...
              for (var n = 0; n < i.timers.length; n++)
                Vistaar.deleteTimeout(i.timers[n]);
              i.timers = [];
            }
    ...
    (e.defaults = { slidesPerView: 1, speed: 300 }),
        ...
        if (!c.data("slider")) {
          ...
          f.forEach(function (i) {
            ...
            t.extend(
              !0,
              g,
              Vistaar.parseOptions(c.attr("data-swiper-options")),
              d
            ),
            i.call(this),
      ...
      (Vistaar.slider = function (i, a = {}, n = !1) {
        Vistaar.$(i).each(function () {
          var i = t(this);
          n
            ? new e(i, a)
      ...
      (Vistaar.slider.pgToggle = function () {
    ...
    (e.prototype.init = function (e) {
      ...
      return (
        ...
        a.$sidebar.length &&
          ...
          a.isNavigation &&
            ((i = i.bind(this)), Vistaar.$window.on("resize", i)),
          Vistaar.$window.on("resize", function (t) {
            Vistaar.windowResized(t.timeStamp) &&
              Vistaar.$body.removeClass(e + "-active");
          }),
          a.$sidebar
          ...
          a.$sidebar
            ...
            .on("click", function (t) {
              Vistaar.$body.removeClass(e + "-active"), t.preventDefault();
            })),
        !1
      );
    }),
      (e.prototype.toggle = function () {
        ...
        if (
          ...
          e.$sidebar
            ...
            Vistaar.$body.toggleClass(e.name + "-active").removeClass("closed");
        setTimeout(function () {
          t(window).trigger("appear.check");
        }, 400);
      }),
      (Vistaar.sidebar = function (t) {
        return new e().init(t);
      });
  })(jQuery),
  (function (t) {
    var e = {
      init: function () {
        var e;
        Vistaar.call(Vistaar.ratingTooltip, 500),
          Vistaar.call(Vistaar.setProgressBar(".progress-bar"), 500),
          this.initVariation(),
          ...
          Vistaar.$body.on("click", ".select-menu a", function (t) {
            t.preventDefault();
          }),
          Vistaar.$body.on("click", ".selected-item i", function (e) {
            t(e.currentTarget)
              .parent()
              .fadeOut(function () {
                var e = t(this),
          ...
          Vistaar.$body.on("mousedown", function (e) {
            t(".select-menu").removeClass("opened");
          }),
          Vistaar.$body.on("click", ".filter-items a", function (e) {
                  ...
                  setTimeout(function () {
                    i.removeClass("load-more-overlay loading"),
                      Vistaar.Minipopup.open({
                        ...
                        actionTemplate:
                          '<a href="#" class="btn btn-rounded btn-sm">View Cart</a><a href="#" class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
                      });
                  }, 500));
            }
          ),
          ...
          (e = t(".product-popup")).length &&
            Vistaar.$body.on("click", ".btn-quickview", function (i) {
              i.preventDefault(),
                Vistaar.popup(
                  {
          ...
          (function () {
            ...
            a.length ||
              ...
              Vistaar.$body.on("click", ".compare-popup-overlay", function () {
                a.removeClass("show");
              });
          })(),
          Vistaar.priceSlider(".filter-price-slider");
      },
                ...
                a.data("load-state", "loading"),
                  ...
                  setTimeout(function () {
                    a.next().removeClass("loading"),
                      ...
                      Vistaar.countDown(i.find(".product-countdown"));
                  }, 500);
                var n = parseInt(
    ...
    (e.min = 1),
      ...
      (e.prototype.startIncrease = function (t) {
        ...
        (e.value = e.$value.val()),
          ...
          (e.increaseTimer = Vistaar.requestTimeout(function () {
            (e.speed = 1),
              (e.increaseTimer = Vistaar.requestInterval(function () {
                e.$value.val(
                  (e.value = Math.min(
      ...
      (e.prototype.startDecrease = function (t) {
        ...
        (e.value = e.$value.val()),
          ...
          (e.decreaseTimer = Vistaar.requestTimeout(function () {
            (e.speed = 1),
              (e.decreaseTimer = Vistaar.requestInterval(function () {
                e.$value.val(
                  (e.value = Math.max(
                    e.value - Math.floor((e.speed *= 1.05)),
                    e.min
      ...
      (e.prototype.stop = function (t) {
        Vistaar.deleteTimeout(this.increaseTimer),
          Vistaar.deleteTimeout(this.decreaseTimer);
      }),
      (Vistaar.initQtyInput = function (i) {
        Vistaar.$(i).each(function () {
          var i = t(this);
    ...
    (e.defaults = {
      ...
      (e.prototype.init = function (i, a) {
        ...
        n.isOpen
          ...
          Vistaar.$body.on("mousedown", ".mfp-wrap", o),
          "ontouchstart" in document &&
            document.addEventListener("touchstart", o, { passive: !0 });
      }),
      (Vistaar.popup = function (t, i) {
        return new e(t, i);
      });
  })(jQuery),
  (function (t) {
    ...
    (e.prototype.init = function (e) {
      ...
      (o.$wrapper = e),
        ...
        (o._isPgVertical = !1),
        o.isQuickView && ((i = i.bind(this)), Vistaar.ratingTooltip()),
        (function (t) {
        ...
        "complete" === Vistaar.status &&
          (Vistaar.slider(s, {
            thumbs: { swiper: o.$thumbsWrap.data("slider") },
          }),
          Vistaar.initQtyInput(e.find(".quantity"))),
        s.length &&
          window.addEventListener(
            "resize",
            function () {
              Vistaar.requestTimeout(function () {
                null != s.data("slider") &&
        ...
        o.$wrapper
          ...
          .on("initialized.slider", function (e) {
            t(e.target).find(".product-image").zoom(Vistaar.zoomImageOptions);
          }),
      ...
      (e.prototype.clickStickyThumbnail = function (e) {
        ...
        o.length && ((o = o.offset().top + 10), Vistaar.scrollTo(o, 500)),
          setTimeout(function () {
      ...
      (Vistaar.productSingle = function (i) {
        return (
          Vistaar.$(i).each(function () {
            var i = t(this);
  ...
  (function (t) {
    ...
    function n(e) {
      ...
      if (i.hasClass("disabled"))
        ...
        if (a.length)
          ...
          var n =
            '<div class="alert alert-success alert-cart-product mb-2">                            <a href="#" class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">“' +
    ...
    Vistaar.initProductSinglePage = function () {
      t(".product-gallery").each(function () {
        var e = t(this),
          i = e.find(".product-image");
        i.length &&
          0 == e.find(".swiper-container").length &&
          i.zoom(Vistaar.zoomImageOptions);
      }),
        (function (e) {
          var i = t(e),
  ...
  (function (t) {
    Vistaar.initCodePopup = function () {
      t(".box-btn.showcode span").each(function () {
        ...
        Vistaar.$body.on("click", ".box-btn.showcode", function () {
          var e = t(this);
          e.hasClass("enabled")
        ...
        Vistaar.$body.on("click", ".show-code", function (e) {
          e.stopPropagation();
          var i = t(this).parent();
          if (i.hasClass("show-code-added")) {
            ...
            i[0].removeChild(a),
              ...
              Vistaar.$body.on("click", ".code-copy a", function (e) {
                e.preventDefault(),
  ...
  (function (t) {
    ...
    (e.defaultOptions = {
      ...
      (e.prototype.init = function (a, n) {
        ...
        (o.element = a),
          (o.settings = t.extend(
            ...
            !0,
            e.defaultOptions,
            Vistaar.parseOptions(a.attr("data-calendar-options")),
            n
          )),
          (o.today = new Date()),
          (i = i.bind(this));
      ...
      (Vistaar.slideContent = function (e) {
        var i = t(e),
          a = i.next();
      ...
      (Vistaar.initLoginVendor = function (e) {
        var i = t(e),
  ...
  jQuery,
  (Vistaar.initLayout = function () {
    Vistaar.isotopes(".grid:not(.grid-float)"),
      Vistaar.stickySidebar(".sticky-sidebar");
  }),
  (Vistaar.init = function () {
    Vistaar.appearAnimate(".appear-animate"),
      Vistaar.setTab(".nav-tabs"),
      Vistaar.stickyContent(".sticky-header", { scrollMode: !1 }),
      Vistaar.stickyContent(".sticky-footer", {
        minWidth: 0,
        maxWidth: 767,
        top: 150,
        hide: !0,
      ...
      Vistaar.stickyContent(".sticky-toolbox", Vistaar.stickyToolboxOptions),
      Vistaar.stickyContent(
        ".product-sticky-content",
        Vistaar.stickyProductOptions
      ),
      Vistaar.parallax(".parallax"),
      Vistaar.skrollrParallax(),
      Vistaar.initFloatingParallax(),
      Vistaar.menu.init(),
      Vistaar.initScrollTopButton(),
      Vistaar.shop.init(),
      Vistaar.alert(".alert"),
      Vistaar.closeTopNotice(".banner-close"),
      Vistaar.accordion(".card-header > a"),
      Vistaar.sidebar("sidebar"),
      Vistaar.sidebar("right-sidebar"),
      Vistaar.productSingle(".product-single"),
      Vistaar.initProductSinglePage(),
      Vistaar.initQtyInput(".quantity"),
      Vistaar.initNavFilter(".nav-filters .nav-filter"),
      Vistaar.calendar(".calendar-container"),
      Vistaar.countDown(".product-countdown, .countdown"),
    
      Vistaar.initNotificationAlert(),
      Vistaar.countTo(".count-to"),
      Vistaar.initCartAction(".cart-offcanvas .cart-toggle"),
   
      Vistaar.headerToggleSearch(".hs-toggle"),
      Vistaar.initVendor(".store"),
      Vistaar.slideContent(".login-toggle"),
      Vistaar.slideContent(".coupon-toggle"),
      Vistaar.slideContent(".checkbox-toggle"),
      Vistaar.initLoginVendor(".user-checkbox"),
     
      Vistaar.slider(".swiper-container"),
      Vistaar.call(Vistaar.slider.pgToggle),
      Vistaar.$window.on("resize", function () {
        Vistaar.call(Vistaar.slider.pgToggle);
      });
  }),
  ...
  (window.onload = function () {
    (Vistaar.canvasWidth = window.innerWidth),
      (Vistaar.resizeTimeStamp = 0),
      (Vistaar.resizeChanged = !1),
      (Vistaar.status = "loaded"),
      document.body.classList.add("loaded"),
      Vistaar.call(Vistaar.initLayout),
      Vistaar.call(Vistaar.init),
      (Vistaar.status = "complete"),
      Vistaar.$window.trigger("Vistaar_complete");
  });
