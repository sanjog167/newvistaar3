...
$("#sort").on('change',function(){
	...
	filterObj.keyWord = keyword;
    var url = "/filter-data-sort";
	$.ajax({
        url:url,
        data:filterObj,
        dataType:'json',
...
// });
function filter(){
	var _minPrice = $('#minprice').val();//gives the minimum price of the product
	...
	filterObj.maxPrice=_actualPrice;
    var url = "/filter-data-price";
    $.ajax({
        url:url,
        data:filterObj,
        dataType:'json',
...
$("#rangeinputmin,#rangeinputmax").on('change',function(){//implementing this script with two different selectors one is category checkbox and another one is price
    //  console.log("checkbox clicked");
     filter();
});
$("#minprice,#maxprice").on('input',function(){//implementing this script with two different selectors one is category checkbox and another one is price
	// console.log("oninput");
	filter();
});
