...
urlpatterns = [
# post views
        path('create_rfq_leads/', views.create_rfq_leads, name='create_rfq_leads'),
        ...
        # reset password urls
        path('password_reset/',auth_views.PasswordResetView.as_view(template_name='sanjog/forgot-password.html', html_email_template_name="sanjog/emailforgotpassword.html"),name='password_reset'),
        path('password_reset/done/',auth_views.PasswordResetDoneView.as_view(),name='password_reset_done'),
        path('reset/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(),name='password_reset_confirm'),
        path('reset/done/',auth_views.PasswordResetCompleteView.as_view(),name='password_reset_complete'),

        #User Registration
        path('register/', views.user_creation_form, name='register'),
        path('user_register/', views.user_creation_form, name='user_register'),
