...
class Primary_leads(models.Model):
    ...
    def __str__(self):
        return 'Order by ' + str(self.buyer.profile) + ' to ' + str(self.seller) + ' for ' + str(self.product) + '(primary)'
...
class RFQ_leads(models.Model):
    ...
    def __str__(self):
        return 'Order by ' + str(self.buyer.profile) + ' to ' + str(self.seller) + ' for ' + str(self.product) + '(rfq_leads)'
...
class Premium_leads(models.Model):
    ...
    def __str__(self):
        return 'Order by ' + str(self.buyer.profile) + ' to ' + str(self.seller) + ' for ' + str(self.product) + '(premium_leads)'
